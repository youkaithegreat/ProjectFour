...
//added use strict per suggestion
"use strict";
...
var resizePizzas = function(size) {
    ...
    //changed querySelectorAll to getElementById per instructions
    ...
    function changePizzaSizes(size) {
        ...
        var rpLength = randomPizzas.length;

        //assigned length to static variable
...
function updatePositions() {
    ...
    for (var k = 0; k < 5; k++) {
        ...
        phase.push(Math.sin((pizzaScrollTop / 1250 + k)));
    }
    ...
    //made items.length into static variable
